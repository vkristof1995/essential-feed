...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_deliversItemsWithValidJSON() {
        ...
        let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "https://google.com")!)
        ...
        let item2 = FeedItem(id: UUID(), description: "desc", location: "loc", imageURL: URL(string: "https://google2.com")!)
